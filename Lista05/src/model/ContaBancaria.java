...
public class ContaBancaria {
    ...
    */
     ...
     * @throws IllegalArgumentException - caso tente ser transferido um valor maior que o limite de transferência
    ...
    /** Método para realizar transferências de uma conta para a outra sem instanciar a classe
     * @author JoaoLavina
     ...
     * @throws IllegalArgumentException - caso tente ser transferido um valor negativo ou igual a zero
     * @throws IllegalArgumentException - caso tente ser transferido um valor maior que o saldo da conta origem
     * @throws IllegalArgumentException - caso tente ser transferido um valor amior que o limite de transferência
     * @see setLimiteTransferencia()
     */
